...
public class SubmitOrderButtonViewManager extends ViewManager {
    ...
    public SubmitOrderButtonViewManager() {
    ...
    private void initNodes() {
        submit = MyButton.getMyButton("Submit", mySmallFont, null);
    ...
    private void setButtonsFunctionality() {
        ...
        submit.setOnAction((e) -> {
            productController.submitOrder(comboBox.getValue(), txtAmount.getText());
            refreshTable();
        });
    }
}
